...
const createUser = async (data) => {
  ...
  await client.set(cacheKey, JSON.stringify(newUser), { EX: 5 });
  return newUser;
};
...
const updateUser = async (data) => {
  ...
  if (updatedUser) {
    ...
    await client.set(cacheKey, JSON.stringify(updatedUser), { EX: 5 });
  }
  return updatedUser;
};
...
const getUserComments = async (userId) => {
  ...
  await client.set(cacheKey, JSON.stringify(comments), { EX: 5 });
  return comments;
};
